...
const InterviewSession = ({
  ...
  return (
    <>
      <BackGroundSVG />
      <div className="w-full min-h-screen flex flex-col px-4 pt-2 pb-8 md:px-8 md:py-2 bg-site relative overflow-x-hidden">
        {completed ? (
          ...
          <div className="h-full w-full items-center flex flex-col my-[5vh]">
            {recordingPermission ? (
